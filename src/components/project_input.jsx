...
export function ProjectInput({ showProjectForm, setProjectform, addProject }) {
  ...
  const insertProject = () => {
    ...
    addProject({ title, description, status, tasks: [] });
  ...
  return (
    <>
      {showProjectForm && (
        <>
          <h3 className="mt-4 text-center">Project Form</h3>
          <form>
